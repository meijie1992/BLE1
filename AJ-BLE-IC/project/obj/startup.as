	...
	; Compiler options:
	;
	; -oaj-b-dk-net-v0.3.cof -maj-b-dk-net-v0.3.map --summary=default \
	; --output=default handle_config.p1 handle_floor.p1 handle_ic_card.p1 \
	; handle_rs485.p1 handle_timer.p1 other.p1 test.p1 24c02.p1 beep.p1 \
	; delay.p1 ds1302.p1 input.p1 interrupt.p1 led.p1 mfrc500.p1 timer.p1 \
	; uart.p1 main.p1 --chip=16F1947 \
	; -ID:\WORKproject\AJ-BLE-IC\source\include -P --runtime=default \
...
;Stack space: 020B0h-0231Fh (624 bytes)
